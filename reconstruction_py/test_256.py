...
class SpeechTokenizer_Class():
    def __init__(self, pretrained: bool=True, 
                 frozen: bool=True,
                 config_path='/ocean/projects/cis220031p/hatwany/SpeechTokenizer/Log/spt_256_10/config.json',
                 ckpt_path='/ocean/projects/cis220031p/hatwany/SpeechTokenizer/Log/spt_256_10/SpeechTokenizer_best_dev.pt'):
        super().__init__()
