...
class SpeechTokenizer_Class():
    def __init__(self, pretrained: bool=True, 
                 frozen: bool=True,
                 config_path='/ocean/projects/cis220031p/hatwany/SpeechTokenizer/Log/spt_base/config.json',
                 ckpt_path='/ocean/projects/cis220031p/hatwany/SpeechTokenizer/Log/spt_base/SpeechTokenizer_best_dev.pt'):
        super().__init__()
...
for i in tqdm(range(1,9)):
    ...
    audio_data = y_pred.squeeze().numpy()  # Remove single-dimensional entries from the shape
    audio_data.shape
    ...
    sf.write(f'{self.out_prefix}_{end_codebook_index}.wav', audio_data, 16000)
